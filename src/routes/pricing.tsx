...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      ...
      { title: "Postpilot Pricing — Plans from KES 1,500 | Nia Studio" },
      { name: "description", content: "Postpilot pricing by Nia Studio: AI LinkedIn post scheduling, video, carousels and analytics. Plans from KES 1,500 per month, billed monthly." },
      { property: "og:title", content: "Postpilot Pricing — Plans from KES 1,500 | Nia Studio" },
      { property: "og:description", content: "AI LinkedIn post scheduling, video, carousels and analytics. Plans from KES 1,500 per month." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Postpilot Pricing — Plans from KES 1,500 | Nia Studio" },
      { name: "twitter:description", content: "AI LinkedIn post scheduling, video, carousels and analytics. Plans from KES 1,500 per month." },
    ],
